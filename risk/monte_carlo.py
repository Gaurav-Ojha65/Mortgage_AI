...
def simulate(
    loan_input: dict, n_simulations: int = 10000, seed: int = None
) -> dict:
    """
    ...
    Args:
        ...
        seed: Optional seed for reproducibility. Production uses None for true randomness.
    ...
    # Only seed for testing/reproducibility - production uses None for true randomness
    if seed is not None:
        np.random.seed(seed)
    ...
    for inc in income_sweep:
        # Use separate random number generator for threshold calc (independence)
